  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <p>By accessing or using TryBlynx, you agree to be bound by these Terms of Service. If you do not agree to these terms, do not use the service.</p>

        <h2 style={{ color: 'white', marginTop: '32px' }}>2. User Conduct & Acceptable Use</h2>
        <p>You agree not to use TryBlynx to:</p>
        <ul>
        ...
        <p>To ensure the safety of our community, TryBlynx employs on-device AI moderation during WebRTC video calls. By using the video call feature, you consent to the automated sampling of video frames. These frames are processed locally on your device and are not transmitted to our servers unless a violation is detected.</p>
        <p>Violations detected by the AI moderation system will result in an immediate automated "Strike". Strikes carry escalating temporary bans (e.g., 15 minutes, 24 hours, 7 days) up to a permanent ban. To enforce bans across multiple accounts, TryBlynx generates and tracks a cryptographic device fingerprint. Banned devices will be prohibited from accessing the service.</p>

        <h2 style={{ color: 'white', marginTop: '32px' }}>4. Privacy and Data</h2>
        <p>Your use of TryBlynx is also governed by our Privacy Policy. Please review it to understand how we collect, use, and share information about you.</p>

        <h2 style={{ color: 'white', marginTop: '32px' }}>5. End-to-End Encryption</h2>
        <p>Direct Messages (DMs) may utilize End-to-End Encryption (E2EE). You acknowledge that if you lose your private cryptographic keys, TryBlynx cannot recover your encrypted messages.</p>

        <h2 style={{ color: 'white', marginTop: '32px' }}>6. Limitation of Liability</h2>
        <p>TryBlynx is provided "as is". We make no warranties regarding the reliability or security of the service. We are not liable for any damages arising from your use of the platform.</p>
      </div>
    </div>
  );
}

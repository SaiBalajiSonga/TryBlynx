  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <p>We use your information to operate the TryBlynx platform, facilitate communication, and enforce our Terms of Service. We use on-device automated AI models to moderate video content. Additionally, we use your device fingerprint to associate hardware with banned accounts and prevent ban evasion.</p>
        ...
        <p>If you use our E2EE Direct Messaging feature, the content of your messages is encrypted on your device. TryBlynx servers cannot read, access, or decrypt these messages.</p>
